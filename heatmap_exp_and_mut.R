#heatmap_exp_and_mut.R
#Purpose: make a heatmap using only the most mutated and highly expressed genes
library(ComplexHeatmap)
library(tidyverse)
library(circlize)
library(fastcluster)

expression_data<-read.csv("derived_data/highly_exp_and_mut_genes_matrix.csv", header=TRUE, sep=",", row.names=1)
...
png("figures/mrna_expression_heatmap_most_mutated_and_exp_genes.png")
